...
const Contact = () => {
    ...
    <>
        ...
        <div className="contact_bottom">
            <div>
                <a href={cvpdf} target='_blank'><img src={cv} alt="cv" /></a>
                <p>CV</p>
            </div>
            <div>
                <a href="mailto:gautier.fournet@gmail.com" target='_blank'><img src={mail} alt="mail" /></a>
                <p>gautier.fournet@gmail.com</p>
            </div>
            <div>
                <a href="https://www.linkedin.com/in/gautier-fournet-9a9643271/" target='_blank'><img src={linkedin} alt="linkedin" /></a>
                <p>Linkedin</p>
            </div>
            <div>
                <a href="https://github.com/gautierfrnt" target='_blank'><img src={github} alt="github" /></a>
                <p>Github</p>
            </div>
        </div>
    </>
